...
```mermaid
flowchart LR
    A["@Test ตัวแรกในคลาสนี้"] --> B["Quarkus สตาร์ตแอปขึ้นมาหนึ่งครั้ง<br/>(ใช้เวลาหน่อยตอนแรก)"]
    B --> C["ทุก @Test ในคลาสถัดไป<br/>ใช้แอปตัวเดียวกัน ไม่สตาร์ตซ้ำ (เร็วขึ้นเรื่อย ๆ)"]
```
